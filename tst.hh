...
Implementacio d'un TST
    Estructura d'un TST:
        -Arbre de nodes (utilitzant punters a c++), on els nodes tenen un caracter c' (valor del node) i un vector de values (int's per indicar posicions on apareix al text)
